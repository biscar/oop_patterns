...
[Abstract Factory(Абстрактная фабрика)](#c1)


### <a name="c1">_Abstract Factory(Абстрактная фабрика), Kit(инструментарий)_</a> 
#### Назначение
...
### _Chain of Responsibility(Цепочка обязанностей)_
#### Назначение
...
### _Template Method(Шаблонный метод)_
#### Назначение
